...
const siteMetadata = {
  title: `Nathanael Noir`,
  description: `Physics, Science, Education`,
  author: `Nathanael Noir`,
  url: `https://nathanaelnoir.com`,
}
...
const plugins = [
  ...
  },
  {
    ...
    // required (have to be specified)
     baseImg: path.resolve('./src/static/base.jpg')
    },
  },
  {
